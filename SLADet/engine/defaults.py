...
from SLADet.modeling import build_model
...
class DefaultPredictor:
    ...
    def __call__(self, original_image, given=False, bbox=None, only_feat=False):
        """
        Args:
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            if not given:
                predictions, pooled_features, pred_ious = self.model([inputs])
                return predictions[0], pooled_features, pred_ious
            else:
                predictions, pooled_features, pred_ious = self.model.extract_reid_feat([inputs], bbox, only_feat=only_feat)
                return predictions[0], pooled_features, pred_ious
