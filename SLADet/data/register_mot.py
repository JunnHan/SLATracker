...
from SLADet.data import DatasetCatalog, MetadataCatalog
from detectron2.data.datasets.coco import load_sem_seg
from SLADet.data.datasets.coco_mot import load_coco_mot_json

"""
This file contains functions to register a COCO-format dataset to the DatasetCatalog.
"""

__all__ = ["register_mot_instances",]
...
def register_mot_instances(name, metadata, json_file, image_root):
    ...
    DatasetCatalog.register(name, lambda: load_coco_mot_json(json_file, image_root, name))
...
def register_mots_panoptic_separated(
    ...
    DatasetCatalog.register(
        ...
        lambda: merge_to_panoptic(
            load_coco_mot_json(instances_json, image_root, panoptic_name),
