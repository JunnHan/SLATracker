...
from SLADet.data.catalog import MetadataCatalog, DatasetCatalog
...
__all__ = ["load_coco_mot_json",]


def load_coco_mot_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None):
    """
...
def convert_to_coco_mot_dict(dataset_name):
    """
    ...
    for image_id, image_dict in enumerate(dataset_dicts):
        ...
        for annotation in anns_per_image:
            ...
            # coco_annotation['track_id'] = annotation['track_id']
...
def convert_to_coco_mot_json(dataset_name, output_folder="", allow_cached=True):
    """
    ...
    if os.path.exists(cache_path) and allow_cached:
        ...
        coco_dict = convert_to_coco_mot_dict(dataset_name)
...
if __name__ == "__main__":
    ...
    dicts = load_coco_mot_json(sys.argv[1], sys.argv[2], sys.argv[3])
