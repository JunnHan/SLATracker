...
from SLADet.data.catalog import MetadataCatalog
...
def transform_instance_annotations(
    ...
    annotation["bbox"] = np.asarray(bbox)
    # if annotation["bbox"][2] > 1920 or annotation["bbox"][3] > 1080:
    # print('ann: {}'.format(annotation["bbox"]))
    # print(np.minimum(bbox, list(image_size + image_size)[::-1]))
    ################################################################################
...
def annotations_to_instances(annos, image_size, mask_format="polygon"):
    ...
    track_id = [[obj["track_id"]] for obj in annos]
    track_id = torch.tensor(track_id, dtype=torch.int64)
    target.gt_trackid = track_id
